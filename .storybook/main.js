const path = require("path"); // Location of root node_modules


const modulesDir = path.join(process.cwd(), "node_modules"); //SEE: https://github.com/storybookjs/storybook/pull/13300#issuecomment-756675536

const updateEmotionAliases = config => ({ ...config,
